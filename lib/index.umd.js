(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('reactstrap'), require('react-bootstrap-switch'), require('@emotion/core'), require('react-dom')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'reactstrap', 'react-bootstrap-switch', '@emotion/core', 'react-dom'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.reactSampleComponentsLibrary = {}, global.React, global.reactstrap, global.ToggleSwitch, global.core, global.reactDom));
}(this, (function (exports, React, reactstrap, ToggleSwitch, core, reactDom) { 'use strict';

  var React__default = 'default' in React ? React['default'] : React;
  ToggleSwitch = ToggleSwitch && Object.prototype.hasOwnProperty.call(ToggleSwitch, 'default') ? ToggleSwitch['default'] : ToggleSwitch;
  ...
  */
  ...
  var Button = /*#__PURE__*/function (_React$Component) {
    ...
    _createClass(Button, [{
      key: "getIconClassBySocial",
      value: function getIconClassBySocial(social) {
        switch (social) {
          case "twitter":
      ...
      value: function render() {
        ...
        return /*#__PURE__*/React__default.createElement(reactstrap.Button, _extends({
          color: social ? social : !color ? "primary" : color,
          size: size,
          active: active,
          disabled: disabled,
          onClick: onClick,
          className: "".concat(link ? "btn-link" : "", " ").concat(round ? "btn-round" : "", " ").concat(simple ? "btn-simple" : "", " ").concat((icon || social) && !children ? "btn-icon" : ""),
          href: href,
          target: target
        }, this.props), social && /*#__PURE__*/React__default.createElement("i", {
          className: this.getIconClassBySocial(social)
        }), icon && !social && icon, (icon || social) && children && " ", icon && children, !icon && !social && (children || !children && "Default text!"));
      }
    }]);
    ...
    _createClass(TextInput, [{
      ...
      value: function render() {
        var _this$props = this.props,
            ...
            regClassName = _this$props.regClassName;
        return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, !form ? /*#__PURE__*/React__default.createElement(reactstrap.InputGroup, {
          size: size,
          className: this.state.focused + " " + regClassName
        }, prepend && /*#__PURE__*/React__default.createElement(reactstrap.InputGroupAddon, {
          addonType: "prepend"
        }, prepend && (!prepend.type || prepend.type === "i") ? /*#__PURE__*/React__default.createElement(reactstrap.InputGroupText, null, prepend) : prepend), /*#__PURE__*/React__default.createElement(reactstrap.Input, _extends({
          placeholder: placeholder,
          onChange: onChange,
          onFocus: this.onFocus,
          onBlur: this.onBlur
        }, this.props)), append && /*#__PURE__*/React__default.createElement(reactstrap.InputGroupAddon, {
          addonType: "append"
        }, append && (!append.type || append.type === "i") ? /*#__PURE__*/React__default.createElement(reactstrap.InputGroupText, null, append) : append)) : /*#__PURE__*/React__default.createElement(reactstrap.FormGroup, {
          className: "".concat(formLabel ? 'has-label' : '', " ").concat(formClassName)
        }, formLabel && /*#__PURE__*/React__default.createElement(reactstrap.Label, null, formLabel), /*#__PURE__*/React__default.createElement(reactstrap.Input, {
          placeholder: placeholder,
          onChange: onChange
        })));
      }
  ...
  var Switch = /*#__PURE__*/function (_React$Component) {
    ...
    _createClass(Switch, [{
      key: "handleChange",
      value: function handleChange(elem, state) {
      ...
      value: function render() {
        ...
        return /*#__PURE__*/React__default.createElement(ToggleSwitch, {
  ...
  */
    ...
    _createClass(Select, [{
      ...
      value: function render() {
        ...
        return /*#__PURE__*/React__default.createElement(index, {
          className: "react-select react-select-".concat(color),
  ...
  var Slider = /*#__PURE__*/function (_React$Component) {
    ...
    _createClass(Slider, [{
      ...
      value: function componentDidMount() {
        var _this$props = this.props,
            rangeMin = _this$props.rangeMin,
            rangeMax = _this$props.rangeMax,
      ...
      value: function render() {
        ...
        return /*#__PURE__*/React__default.createElement("div", {
          className: "slider ".concat(color ? "slider-".concat(color) : ""),
          ref: "slider"
        });
      }
    }]);
  ...
  var reactTagsinput = createCommonjsModule(function (module, exports) {
  (function (global, factory) {
    {
      factory(module, exports, React__default, propTypes);
    }
  })(commonjsGlobal, function (module, exports, _react, _propTypes) {
  ...
  var TagsInput = unwrapExports(reactTagsinput);
  ...
  var Tags = /*#__PURE__*/function (_React$Component) {
    ...
    function Tags(props) {
      ...
      _this.handleTags = _this.handleTags.bind(_assertThisInitialized(_this));
      return _this;
    }

    _createClass(Tags, [{
      key: "handleTags",
      value: function handleTags(tags) {
        var onChange = this.props.onChange;
        this.setState({
          tags: tags
        });
      ...
      value: function render() {
        ...
        return /*#__PURE__*/React__default.createElement(TagsInput, _extends({
          ...
          tagProps: {
            className: "react-tagsinput-tag ".concat(color),
            style: !uppercase ? {
              textTransform: "none"
            } : {}
          }
  ...
  var InfoArea = /*#__PURE__*/function (_React$Component) {
    _inherits(InfoArea, _React$Component);

    var _super = _createSuper(InfoArea);
    ...
    _createClass(InfoArea, [{
      key: "getBlobByColor",
      value: function getBlobByColor(color) {
        switch (color) {
          case "black":
      ...
      value: function render() {
        var _this$props = this.props,
            ...
            append = _this$props.append,
            noBlob = _this$props.noBlob;
        return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement("div", {
          className: "info info-".concat(hover ? "hover" : "horizontal")
        }, /*#__PURE__*/React__default.createElement("div", {
          className: "icon icon-".concat(iconColor)
        }, !noBlob && /*#__PURE__*/React__default.createElement("img", {
          alt: "...",
          className: "bg-blob",
        ...
        }, title), description && /*#__PURE__*/React__default.createElement("p", null, description), append && append)));
      }
    }]);
  ...
  InfoArea.defaultProps = {
    ...
    icon: /*#__PURE__*/React__default.createElement("i", {
      className: "tim-icons icon-html5"
    }),
    iconColor: "primary",
    hover: true
  };
    ...
    _createClass(Text, [{
      ...
      value: function render() {
        ...
        return /*#__PURE__*/React__default.createElement(Tag, _extends({
          className: "".concat(display ? "display-".concat(display, " ") : "").concat(muted ? "text-muted " : "").concat(lead ? "lead " : "").concat(color ? "text-".concat(color, " ") : "").concat(inline ? "w-auto d-inline-block " : "").concat(className),
  ...
  var Dropdown = /*#__PURE__*/function (_React$Component) {
    ...
    _createClass(Dropdown, [{
      ...
      value: function render() {
        ...
        return /*#__PURE__*/React__default.createElement(reactstrap.UncontrolledDropdown, {
          group: inline,
          direction: direction
        ...
        }, label), /*#__PURE__*/React__default.createElement(reactstrap.DropdownMenu, null, options.map(function (_ref, index) {
          ...
          return /*#__PURE__*/React__default.createElement(reactstrap.DropdownItem, {
            ...
            disabled: disabled,
            divider: divider,
            href: href && !_onClick && href,
            target: target && href && !_onClick && target,
  ...
  var Progress = /*#__PURE__*/function (_React$Component) {
    ...
    _createClass(Progress, [{
      ...
      value: function render() {
        ...
        console.log(values);
        return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, !multi ? /*#__PURE__*/React__default.createElement("div", {
          className: "progress-container ".concat(color ? "progress-".concat(color) : "")
        }, /*#__PURE__*/React__default.createElement("span", {
          className: "progress-badge"
        }, label), /*#__PURE__*/React__default.createElement(reactstrap.Progress, {
          max: max,
          value: value,
          striped: striped
        }, /*#__PURE__*/React__default.createElement("span", {
          className: "progress-value"
        }, (value / max * 100).toFixed(0), "%"))) : /*#__PURE__*/React__default.createElement(reactstrap.Progress, {
          multi: multi
        }, values.map(function (obj, index) {
          return /*#__PURE__*/React__default.createElement(reactstrap.Progress, {
            bar: true,
            value: "".concat(obj.value),
            color: obj.color ? obj.color : "secondary",
            striped: striped,
            max: max
          });
        })));
    ...
    _createClass(ToolTip, [{
      ...
      value: function render() {
        var _this$props = this.props,
            ...
            label = _this$props.label;
        return /*#__PURE__*/React__default.createElement(reactstrap.UncontrolledTooltip, {
          placement: placement,
          target: target,
          delay: delay
        }, label);
    ...
    _createClass(Tabs, [{
      ...
      value: function render() {
        ...
        var _this$props = this.props,
            ...
            pillColor = _this$props.pillColor,
            vertical = _this$props.vertical,
            tabPlacement = _this$props.tabPlacement,
            textPlacement = _this$props.textPlacement;
        var navBar = /*#__PURE__*/React__default.createElement(React__default.Fragment, null, labels.map(function (label, index) {
          return /*#__PURE__*/React__default.createElement(reactstrap.NavItem, {
            className: "".concat(index > 0 ? "m".concat(vertical ? "t" : "l", "-1") : "", " ").concat(index < labels.length - 1 ? "m".concat(vertical ? "b" : "r", "-1") : "")
          }, /*#__PURE__*/React__default.createElement(reactstrap.NavLink, {
            className: _this2.state.activeTab === index ? "active" : "",
            onClick: function onClick() {
              return _this2.toggle(index);
            }
          }, label));
        }));
        var tabContent = /*#__PURE__*/React__default.createElement(reactstrap.TabContent, {
          activeTab: this.state.activeTab
        }, content.map(function (val, index) {
          return /*#__PURE__*/React__default.createElement(reactstrap.TabPane, {
            tabId: index,
            className: "".concat(textPlacement ? "text-".concat(textPlacement) : "")
          }, val);
        }));
        if (vertical) return /*#__PURE__*/React__default.createElement(reactstrap.Row, null, /*#__PURE__*/React__default.createElement(reactstrap.Col, {
          md: "4",
          xs: "12"
        }, /*#__PURE__*/React__default.createElement(reactstrap.Nav, {
          tabs: !pills,
          pills: pills,
          className: "".concat(pills ? "nav-pills-".concat(pillColor, " ") : "").concat(vertical ? "flex-column " : "")
        }, navBar)), /*#__PURE__*/React__default.createElement(reactstrap.Col, {
          md: "8",
          xs: "12"
        }, tabContent));
        return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement("div", {
          ...
          tabs: !pills,
          pills: pills,
          className: "".concat(pills ? "nav-pills-".concat(pillColor, " ") : "").concat(tabPlacement ? "justify-content-".concat(tabPlacement) : "")
        }, navBar))), /*#__PURE__*/React__default.createElement("br", null), tabContent);
      }
    }]);
    ...
    _createClass(Card, [{
      ...
      value: function render() {
        var _this$props = this.props,
            ...
            style = _this$props.style,
            color = _this$props.color;
        return /*#__PURE__*/React__default.createElement(reactstrap.Card, _extends({
          style: _objectSpread2({
            width: width && width
          }, style),
          color: color
        }, this.props), imgSrc && /*#__PURE__*/React__default.createElement(reactstrap.CardImg, {
          top: true,
          width: "100%",
          src: imgSrc,
          alt: "..."
        }), header && /*#__PURE__*/React__default.createElement(reactstrap.CardHeader, null, header), /*#__PURE__*/React__default.createElement(reactstrap.CardBody, null, children), footer && /*#__PURE__*/React__default.createElement(reactstrap.CardFooter, null, footer));
      }
    }]);
